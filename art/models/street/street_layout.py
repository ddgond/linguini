...
toward -Z). The bedroom is on the third floor, so the street is well below.
   ...
   +---------------------+   cross   +----------------------+
   | far row: rowhouses, | street    | corner cafe, more    |   far facades at z = -20.2
   | corner shop         |  (going   | rowhouses            |
   +---------------------+  away)    +----------------------+
   far sidewalk            .  .  .                               z = -16.6 .. -20.2
   parking lane  ============================================
...
# Our building's windows, either side of the bedroom's (x of their centres).
OUR_WINDOWS = [-4.4, 4.1]
